...
class Okex:
    ...
    def options(self, expiry, strike, callPut):
        s = '/api/option/v3/instruments/BTC-USD/summary/BTC-USD-' + expiry + '-' + strike + '-' + callPut.upper()
        return self.__get(s)

    def optionStrikes(self, expiry):
        s = '/api/option/v3/instruments/BTC-USD/summary?delivery=' + expiry
        return self.__get(s)
